...
const generateEmailChangeVerificationHTML = (otp, name, newEmail) => {
    const displayName = name && name.trim() ? name.trim() : "there";
    return `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Verify your new email address - Shortlist AI</title>
</head>
<body style="margin: 0; padding: 0; background-color: #f4f4f5; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #18181b;">
  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f4f4f5; padding: 40px 16px;">
    <tr>
      <td align="center">
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 480px; background-color: #ffffff; border: 1px solid #e4e4e7; border-radius: 12px; padding: 32px;">
          ...
          <tr>
            <td style="padding-top: 24px;">
              <h1 style="font-size: 20px; font-weight: 600; color: #18181b; margin: 0 0 12px 0;">Verify your new email address</h1>
              ...
              <p style="font-size:15px;line-height:1.6;color:#52525b;margin:0 0 16px 0;">
                We received a request to change the email address associated with your Shortlist AI account to:
              </p>

              <p style="font-size: 15px; font-weight: 600; color: #18181b; margin: 0 0 24px 0;">
                ${newEmail}
              </p>

              <p style="font-size:15px;line-height:1.6;color:#52525b;margin:0 0 24px 0;">
                Use the verification code below to confirm this change. If you did not initiate this request, you can ignore this email.
              </p>
              ...
              <p style="font-size: 13px; color: #a1a1aa; margin: 0; line-height: 1.4;">
                <strong>Note:</strong> Your email will only be updated after successful verification.
              </p>
            </td>
          </tr>
